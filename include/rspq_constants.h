...
#define RSPQ_DRAM_LOWPRI_BUFFER_SIZE   0x1000  ///< Size of each RSPQ RDRAM buffer for lowpri queue (in 32-bit words)  [cd-i P0a: 0x200->0x1000 back-pressure experiment]
